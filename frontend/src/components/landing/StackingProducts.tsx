  ...
  return (
    <div className="sticky top-24 flex items-center justify-center md:top-28">
      <motion.article
        ...
        className="stack-card relative mx-auto w-full max-w-3xl origin-top overflow-hidden rounded-[26px] border-2 border-[#D7E2EA]/60 bg-[#0C0C0C] p-3.5 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)] sm:rounded-[32px] sm:p-5"
      >
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-[minmax(360px,1fr)_minmax(220px,300px)] lg:grid-cols-[minmax(480px,1fr)_minmax(240px,310px)]">
          <div className="aspect-[7/5] overflow-hidden rounded-[20px] bg-black/40 sm:rounded-[24px]">
          ...
          <div className="flex flex-col justify-between gap-4 rounded-[20px] border border-white/10 bg-white/[0.03] p-4 sm:rounded-[24px]">
            <div>
              {p.descripcionLarga && (
                <p className="mb-3 line-clamp-2 text-sm font-light leading-relaxed text-[#D7E2EA]/65">
                  {p.descripcionLarga}
                </p>
              )}
